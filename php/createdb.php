...
$createtable = "CREATE TABLE university (uname varchar(100),country varchar(50),rollno varchar(9),faculty varchar(100), recommReq varchar(30),recStatus varchar(20),status varchar(30))";
if ($sqldb->query($createtable)) {
